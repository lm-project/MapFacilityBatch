...
public class WashDataBdCoverMultiAnTest {

	@Test
	public void testWash() throws ClassNotFoundException, SQLException, FileNotFoundException,
	IOException {
		...
		try {
			...
			WashedData washedData = new WashDataBdCoverMultiAn(washedDataB).wash();
	...
	@Test
	public void testWashDataBdCoverMultiAn() {
